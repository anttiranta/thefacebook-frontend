...
const Privacy = () => {
    return (
        <div id="privacy_box">
            ...
            <div style={{backgroundColor: "#4C70A0", color: "white"}}>Coverage</div>
                <p>
            ...
            <div id="privacy_boxes">
            <div style={{backgroundColor: "#4C70A0", color: "white"}}>About Thefacebook and the Information We Collect</div>
                <p>
            ...
            <div id="privacy_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Information Collected by Thefacebook</div>
                <p>
            ...
            <div id="privacy_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Use of Information Obtained by Thefacebook</div>
                <p>
            ...
            <div id="privacy_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Spam Policy</div>
                <p>
                ...
                <div id="privacy_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Links</div>
                <p>
            ...
            <div id="privacy_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Use of Cookies</div>
                <p>
                ...
                <div id="privacy_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Third Party Advertising</div>
                <p>
            ...
            <div id="privacy_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Changing or Removing Information</div>
                <p>
            ...
            <div id="privacy_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Changes in Our Privacy Policy</div>
                <p>
