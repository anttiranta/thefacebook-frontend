...
const Faq = () => {
    return (
        <div id="faq_box">
            ...
            <div id="faq_boxes">
                <a name="0"></a>
                <div name="" style={{backgroundColor: "#4C70A0", color: "white"}}>What is Thefacebook?</div>
                <p>
            ...
            <div id="faq_boxes">
                <a name="1"></a>
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>How do you get our information? Does the school give it to you?</div>
                <p>
            ...
            <div id="faq_boxes">
                <a name="3"></a>
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>What is the social net?</div>
                <p>
            ...
            <div id="faq_boxes">
                <a name="4"></a>
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Why does the social net repeat people?</div>
                <p>
            ...
            <div id="faq_boxes">
                <a name="5"></a>
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>How do I search for something besides names?</div>
                <p>
            ...
            <div id="faq_boxes">
                <a name="6"></a>
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>If I reject someone, will they find out?</div>
                <p>
            ...
            <a name="7"></a>
                <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>If I remove someone from my friends list, are they notified?</div>
                <p>
            ...
            <a name="8"></a>
            <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>How can I view the visualization?</div>
                <p id="faq_box_links">
            ...
            <a name="9"></a>
                <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Why is the visualization slow?</div>
                <p>
            ...
            <a name="10"></a>
            <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>How do I navigate through the visualization?</div>
                <p>
            ...
            <a name="11"></a>
            <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Can I change my name and password?</div>
                <p>
            ...
            <a name="12"></a>
            <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>When I try to log in, the page just refreshes. What's going on?</div>
                <p>
            ...
            <a name="13"></a>
            <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>What is poking?</div>
                <p>
            ...
            <a name="14"></a>
            <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Who made this site?</div>
                <p id="faq_box_links">
            ...
            <a name="15"></a>
            <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>When was the site started?</div>
                <p>
            ...
            <a name="16"></a>
            <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>Is this a class project?</div>
                <p>
                    Nope, just for fun.
                </p>
            </div>
            <a name="17"></a>
            <div id="faq_boxes">
                <div style={{backgroundColor: "#4C70A0", color: "white"}}>What kind of graph theory algorithms are you using to process connections?</div>
                <p>
